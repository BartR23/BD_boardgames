...
--------------------------------------------------------
--  DDL for Sequence MASZYNY_LICZNIK
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."MASZYNY_LICZNIK"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 10 START WITH 80 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table AWARIE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."AWARIE" 
   (	"CZAS" DATE, 
	"USUNIĘTA" CHAR(1 BYTE), 
	"OPIS" CLOB, 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table GP_ELEMENTY_ROZGRYWKI
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" 
   (	"ID_ELEMENTU_ROZGRYWKI" NUMBER(6,0), 
	"OPIS_ELEMENTU_ROZGRYWKI" VARCHAR2(200 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_ELEMENTY_ZESTAWU
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" 
   (	"ID_ELEMENTU_ZESTAWU" NUMBER(6,0), 
	"LICZBA_KOMPONENTOW" NUMBER(*,0), 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_ELEMENTY_ZESTAWU" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_GRY_PLANSZOWE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_GRY_PLANSZOWE" 
   (	"ID_GRY" NUMBER(4,0), 
	...
	"ID_PIERWOTNEJ_WERSJI" NUMBER(4,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_GRY_PLANSZOWE" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_KATEGORIE_LICZBY_GRACZY
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" 
   (	"ID_LICZBY_GRACZY" NUMBER(2,0), 
	"NAZWA_K_L_GRACZY" VARCHAR2(30 BYTE), 
	"MIN_LICZBA_GRACZY" NUMBER(*,0), 
	"MAX_LICZBA_GRACZY" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_KATEGORIE_WIEKOWE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_KATEGORIE_WIEKOWE" 
   (	"ID_KATEGORII_WIEKOWEJ" NUMBER(2,0), 
	"NAZWA_K_WIEKOWEJ" VARCHAR2(30 BYTE), 
	"MINIMALNY_WIEK" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_KATEGORIE_WIEKOWE" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_KOMPONENTY
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_KOMPONENTY" 
   (	"ID_KOMPONENTU" NUMBER(2,0), 
	"NAZWA_KOMPONENTU" VARCHAR2(30 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_KOMPONENTY" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_LOKALIZACJE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_LOKALIZACJE" 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_LOKALIZACJE" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_MECHANIKI
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_MECHANIKI" 
   (	"ID_MECHANIKI" NUMBER(3,0), 
	"NAZWA_MECHANIKI" VARCHAR2(30 BYTE), 
	"OPIS_MECHANIKI" VARCHAR2(200 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_MECHANIKI" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_MECHANIKI_KOPIA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_MECHANIKI_KOPIA" 
   (	"ID_MECHANIKI" NUMBER(3,0), 
	"NAZWA_MECHANIKI" VARCHAR2(30 BYTE), 
	"OPIS_MECHANIKI" VARCHAR2(200 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table GP_MOTYWY
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_MOTYWY" 
   (	"ID_MOTYWU" NUMBER(2,0), 
	"NAZWA_MOTYWU" VARCHAR2(30 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_MOTYWY" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_OCENY
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_OCENY" 
   (	"ID_OCENY" NUMBER(2,0), 
	"OCENA" NUMBER(2,1)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_OCENY" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_PRODUCENCI
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_PRODUCENCI" 
   (	"ID_PRODUCENTA" NUMBER(4,0), 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_PRODUCENCI" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_RECENZENCI
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_RECENZENCI" 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
  GRANT SELECT ON "SYSTEM"."GP_RECENZENCI" TO "PRZEGLADANIE";
--------------------------------------------------------
--  DDL for Table GP_RECENZJE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GP_RECENZJE" 
   (	"ID_RECENZJI" NUMBER(4,0), 
	"RECENZJA" CLOB, 
	"ID_GRY" NUMBER(4,0), 
	"ID_RECENZENTA" NUMBER(3,0), 
	"ID_OCENY" NUMBER(2,0)
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" 
 LOB ("RECENZJA") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW 4000 CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
  GRANT SELECT ON "SYSTEM"."GP_RECENZJE" TO "PRZEGLADANIE";
  GRANT DELETE ON "SYSTEM"."GP_RECENZJE" TO "RECENZENT";
  GRANT INSERT ON "SYSTEM"."GP_RECENZJE" TO "RECENZENT";
  GRANT SELECT ON "SYSTEM"."GP_RECENZJE" TO "RECENZENT";
  GRANT UPDATE ON "SYSTEM"."GP_RECENZJE" TO "RECENZENT";
--------------------------------------------------------
--  DDL for Table HALE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HALE" 
   (	"ID_HALI" NUMBER(2,0), 
...
--------------------------------------------------------
--  DDL for Table OPERATOR_MASZYNA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."OPERATOR_MASZYNA" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."OPERATORZY" 
   (	"ID_OPERATORA" NUMBER(4,0), 
	"NAZWISKO" VARCHAR2(25 BYTE), 
	"IMIE" VARCHAR2(25 BYTE), 
	"DATA_ZATRUDNIENIA" DATE, 
	"PLACA" NUMBER(6,2), 
	"PRZEŁOŻONY" NUMBER(4,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table ZESPOL
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ZESPOL" 
   (	"ID_ZESP" NUMBER(2,0), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for View MASZYNY_USZKODZONE
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."MASZYNY_USZKODZONE" ("ID_MASZYNY", "NAZWA") AS 
  select m.id_maszyny, m.nazwa
   from maszyny m join awarie a on m.id_maszyny = a.id_maszyny
   where NVL(a.usunięta,'N') = 'N'
;
--------------------------------------------------------
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.AWARIE
SET DEFINE OFF;
Insert into SYSTEM.AWARIE (CZAS,"USUNIĘTA",ID_MASZYNY) values (to_date('13/07/07','RR/MM/DD'),'T','50');
Insert into SYSTEM.AWARIE (CZAS,"USUNIĘTA",ID_MASZYNY) values (to_date('23/12/10','RR/MM/DD'),'T','20');
Insert into SYSTEM.AWARIE (CZAS,"USUNIĘTA",ID_MASZYNY) values (to_date('07/01/11','RR/MM/DD'),'T','40');
Insert into SYSTEM.AWARIE (CZAS,"USUNIĘTA",ID_MASZYNY) values (to_date('12/03/11','RR/MM/DD'),null,'20');
Insert into SYSTEM.AWARIE (CZAS,"USUNIĘTA",ID_MASZYNY) values (to_date('17/11/12','RR/MM/DD'),null,'60');
REM INSERTING into SYSTEM.ETAT
SET DEFINE OFF;
Insert into SYSTEM.ETAT (NAZWA,PLACA_MIN,PLACA_MAX) values ('STA�YSTA','800','1000');
Insert into SYSTEM.ETAT (NAZWA,PLACA_MIN,PLACA_MAX) values ('SEKRETARKA','900','1200');
Insert into SYSTEM.ETAT (NAZWA,PLACA_MIN,PLACA_MAX) values ('ASYSTENT','1000','1600');
Insert into SYSTEM.ETAT (NAZWA,PLACA_MIN,PLACA_MAX) values ('ADIUNKT','1600','2000');
Insert into SYSTEM.ETAT (NAZWA,PLACA_MIN,PLACA_MAX) values ('PROFESOR','2000','2500');
Insert into SYSTEM.ETAT (NAZWA,PLACA_MIN,PLACA_MAX) values ('DYREKTOR','2500','3200');
REM INSERTING into SYSTEM.GP_ELEMENTY_ROZGRYWKI
SET DEFINE OFF;
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1010','Skupowanie obszarów','301','5001');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1020','Skupowanie obszarów','301','5002');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1040','Gromadzenie terytoriów','303','5002');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1030','Bitwy','335','5002');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1050','Budowanie scenariuszy','305','5003');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1060','Wznoszenie budowli','307','5004');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1070','Współpraca graczy','309','5005');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1080','Gra na podzielonej planszy','311','5006');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1090','Gospodarowanie zasobami','313','5007');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1100','Gromadzenie terytoriów','303','5007');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1110','Skupowanie obszarów','301','5007');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1120','Zdobywanie wiedzy','315','5008');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1130','Wzajemne zgadywanie','317','5009');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1140','Próba odgadnięcia roli gracza','319','5010');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1150','Odszukiwanie zapamiętanych obrazów','321','5011');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1160','Wzajemna interakcja','325','5012');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1170','Wzajemne zgadywanie','317','5012');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1180','Ułożenie docelowego wzoru','329','5013');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1190','Znajomość słownictwa','333','5014');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1200','Opracowanie strategii','335','5015');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1210','Gromadzenie terytoriów','303','5016');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1220','Współpraca graczy','309','5017');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1230','Opracowanie strategii','335','5017');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1240','Gospodarowanie zasobami','313','5018');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1250','Gromadzenie terytoriów','303','5018');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1260','Skupowanie obszarów','301','5018');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1270','Gospodarowanie zasobami','313','5019');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1280','Gromadzenie terytoriów','303','5019');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1290','Skupowanie obszarów','301','5019');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1300','Skupowanie obszarów','301','5020');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1310','Współpraca graczy','309','5020');
Insert into SYSTEM.GP_ELEMENTY_ROZGRYWKI (ID_ELEMENTU_ROZGRYWKI,OPIS_ELEMENTU_ROZGRYWKI,ID_MECHANIKI,ID_GRY) values ('1320','Gromadzenie terytoriów','303','5020');
REM INSERTING into SYSTEM.GP_ELEMENTY_ZESTAWU
SET DEFINE OFF;
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3000','170','13','5008');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3001','60','13','5007');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3002','2','11','5007');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3003','104','16','5007');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3004','161','16','5001');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3005','119','13','5001');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3006','2','12','5002');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3007','152','13','5002');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3008','1','15','5002');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3009','180','16','5002');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3010','10','17','5002');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3011','350','13','5003');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3012','266','16','5003');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3013','1','12','5004');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3014','148','13','5004');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3015','1','15','5004');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3016','126','16','5004');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3017','7','17','5004');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3018','118','13','5005');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3019','125','16','5005');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3020','1','11','5006');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3021','16','16','5006');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3022','241','16','5009');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3023','2','17','5009');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3024','30','13','5010');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3025','21','16','5010');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3026','240','13','5011');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3027','1','15','5011');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3028','25','17','5011');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3029','110','13','5012');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3030','1','15','5012');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3031','76','16','5012');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3032','84','16','5013');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3033','4','15','5014');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3034','100','17','5014');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3035','8','11','5015');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3036','462','13','5015');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3037','1068','16','5015');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3038','75','17','5015');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3039','90','13','5016');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3040','12','16','5016');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3041','85','17','5016');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3042','4','11','5017');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3043','1','12','5017');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3044','303','13','5017');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3045','16','15','5017');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3046','245','16','5017');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3047','12','17','5017');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3048','65','13','5018');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3049','2','11','5018');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3050','114','16','5018');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3051','60','13','5019');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3052','2','11','5019');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3053','104','16','5019');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3054','5','11','5020');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3055','1','12','5020');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3056','76','13','5020');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3057','8','15','5020');
Insert into SYSTEM.GP_ELEMENTY_ZESTAWU (ID_ELEMENTU_ZESTAWU,LICZBA_KOMPONENTOW,ID_KOMPONENTU,ID_GRY) values ('3058','131','16','5020');
REM INSERTING into SYSTEM.GP_GRY_PLANSZOWE
SET DEFINE OFF;
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5001','El Grande','1',to_date('95/03/01','RR/MM/DD'),'11','35','14','1080',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5002','Scythe','1',to_date('16/04/10','RR/MM/DD'),'11','15','14','1100',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5003','Charterstone','1',to_date('17/05/15','RR/MM/DD'),'11','15','14','1100',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5004','7 Wonders','1',to_date('10/06/01','RR/MM/DD'),'11','50','14','1090',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5005','Pandemic','1',to_date('08/07/14','RR/MM/DD'),'11','65','14','1070',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5006','Ludo Trefl','1',to_date('04/04/02','RR/MM/DD'),'10',null,'14','1140',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5007','Monopoly Hasbro','1',to_date('92/09/11','RR/MM/DD'),'11','30','14','1020',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5008','Wingspan','1',to_date('19/02/03','RR/MM/DD'),'10','25','14','1100',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5009','Battleship Hasbro','1',to_date('94/04/04','RR/MM/DD'),'11','55','12','1020',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5010','Mafia Egmont','1',to_date('12/08/08','RR/MM/DD'),'11','40','16','1120',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5011','Codenames','1',to_date('15/12/09','RR/MM/DD'),'10','10','14','1050',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5012','Concept','1',to_date('13/07/18','RR/MM/DD'),'10','80','16','1090',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5013','Blokus','1',to_date('00/09/01','RR/MM/DD'),'10',null,'14','1030',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5014','Scrabble','1',to_date('48/03/01','RR/MM/DD'),'10',null,'14','1020',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5015','Twilight Imperium','1',to_date('97/10/11','RR/MM/DD'),'11','65','14','1040',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5016','TransAmerica','1',to_date('00/12/12','RR/MM/DD'),'11','75','14','1080',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5017','Eldritch Horror','1',to_date('13/08/18','RR/MM/DD'),'12','65','14','1040',null);
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5018','Monopoly Star Wars','2',to_date('17/01/13','RR/MM/DD'),'11','65','14','1020','5007');
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5019','Monopoly Super Mario','3',to_date('23/06/21','RR/MM/DD'),'10','10','14','1020','5007');
Insert into SYSTEM.GP_GRY_PLANSZOWE (ID_GRY,NAZWA,NR_WERSJI,DATA_WYDANIA,ID_KATEGORII_WIEKOWEJ,ID_MOTYWU,ID_LICZBY_GRACZY,ID_PRODUCENTA,ID_PIERWOTNEJ_WERSJI) values ('5020','My Little Scythe','2',to_date('20/07/12','RR/MM/DD'),'10','10','14','1100','5002');
REM INSERTING into SYSTEM.GP_KATEGORIE_LICZBY_GRACZY
SET DEFINE OFF;
Insert into SYSTEM.GP_KATEGORIE_LICZBY_GRACZY (ID_LICZBY_GRACZY,NAZWA_K_L_GRACZY,MIN_LICZBA_GRACZY,MAX_LICZBA_GRACZY) values ('10','One-player','1','1');
Insert into SYSTEM.GP_KATEGORIE_LICZBY_GRACZY (ID_LICZBY_GRACZY,NAZWA_K_L_GRACZY,MIN_LICZBA_GRACZY,MAX_LICZBA_GRACZY) values ('12','Two-player','2','2');
Insert into SYSTEM.GP_KATEGORIE_LICZBY_GRACZY (ID_LICZBY_GRACZY,NAZWA_K_L_GRACZY,MIN_LICZBA_GRACZY,MAX_LICZBA_GRACZY) values ('14','Multiplayer','2','8');
Insert into SYSTEM.GP_KATEGORIE_LICZBY_GRACZY (ID_LICZBY_GRACZY,NAZWA_K_L_GRACZY,MIN_LICZBA_GRACZY,MAX_LICZBA_GRACZY) values ('16','Large multiplayer','4',null);
REM INSERTING into SYSTEM.GP_KATEGORIE_WIEKOWE
SET DEFINE OFF;
Insert into SYSTEM.GP_KATEGORIE_WIEKOWE (ID_KATEGORII_WIEKOWEJ,NAZWA_K_WIEKOWEJ,MINIMALNY_WIEK) values ('10','Children''s','4');
Insert into SYSTEM.GP_KATEGORIE_WIEKOWE (ID_KATEGORII_WIEKOWEJ,NAZWA_K_WIEKOWEJ,MINIMALNY_WIEK) values ('11','Family','8');
Insert into SYSTEM.GP_KATEGORIE_WIEKOWE (ID_KATEGORII_WIEKOWEJ,NAZWA_K_WIEKOWEJ,MINIMALNY_WIEK) values ('12','Adult','18');
REM INSERTING into SYSTEM.GP_KOMPONENTY
SET DEFINE OFF;
Insert into SYSTEM.GP_KOMPONENTY (ID_KOMPONENTU,NAZWA_KOMPONENTU) values ('11','kostka');
Insert into SYSTEM.GP_KOMPONENTY (ID_KOMPONENTU,NAZWA_KOMPONENTU) values ('12','książka');
Insert into SYSTEM.GP_KOMPONENTY (ID_KOMPONENTU,NAZWA_KOMPONENTU) values ('13','karty');
Insert into SYSTEM.GP_KOMPONENTY (ID_KOMPONENTU,NAZWA_KOMPONENTU) values ('14','akcesoria elektroniczne');
Insert into SYSTEM.GP_KOMPONENTY (ID_KOMPONENTU,NAZWA_KOMPONENTU) values ('15','system gry');
Insert into SYSTEM.GP_KOMPONENTY (ID_KOMPONENTU,NAZWA_KOMPONENTU) values ('16','miniaturki');
Insert into SYSTEM.GP_KOMPONENTY (ID_KOMPONENTU,NAZWA_KOMPONENTU) values ('17','kafelki');
REM INSERTING into SYSTEM.GP_LOKALIZACJE
SET DEFINE OFF;
Insert into SYSTEM.GP_LOKALIZACJE (ID_LOKALIZACJI,KRAJ) values ('101','Francja');
Insert into SYSTEM.GP_LOKALIZACJE (ID_LOKALIZACJI,KRAJ) values ('102','Stany Zjednoczone');
Insert into SYSTEM.GP_LOKALIZACJE (ID_LOKALIZACJI,KRAJ) values ('103','Czechy');
Insert into SYSTEM.GP_LOKALIZACJE (ID_LOKALIZACJI,KRAJ) values ('104','Niemcy');
Insert into SYSTEM.GP_LOKALIZACJE (ID_LOKALIZACJI,KRAJ) values ('105','Polska');
Insert into SYSTEM.GP_LOKALIZACJE (ID_LOKALIZACJI,KRAJ) values ('106','Chiny');
REM INSERTING into SYSTEM.GP_MECHANIKI
SET DEFINE OFF;
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('301','Auction','Aukcyjne gry planszowe to te, które używają licytacji, przypisywania wartości do różnych przedmiotów');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('303','Area control','Gry z jakąś formą mapy lub planszy definiującą przestrzeń, o którą gracze konkurują, aby dominować');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('305','Campaign','Gry są definiowane przez graczy po serii powiązanych scenariuszy, w których wynik jednego scenariusza będzie miały wpływ na następny');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('307','City building','Gry obejmują budowanie i zarządzanie miastem poprzez decyzje dotyczące planowania');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('309','Cooperative','To gry, w których wszyscy gracze pracują razem, aby osiągnąć wspólny cel, a nie konkurować ze sobą');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('311','Cross and circle','To gry wyścigowe z planszami składającymi się z koła podzielonego na cztery równe części przez krzyż wpisany w niego');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('313','Economic','Gry planszowe obejmujące zarządzanie zasobami i podejmowanie mądrych decyzji o tym, jak wydawać lub inwestować pieniądze');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('315','Educational','To gry, które mają na celu nauczanie nowych pomysłów, koncepcji, tematów');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('317','Guessing','To gry, które angażują gracza lub graczy, odgadujących odpowiedź na pytanie w oparciu o wskazówki innego gracza');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('319','Hidden role','To gry z udziałem gracza lub graczy z ukrytą rolą w grupie, w której reszta graczy musi ją zidentyfikować');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('321','Memory','Gry pamięciowe dotyczą zapamiętywania pewnych faktów, liczb i innych informacji');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('323','Paper-and-pencil','To gry, które można odtwarzać wyłącznie za pomocą narzędzi do pisania, zwykle bez wymazywania');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('325','Party','To gry, które zachęcają do interakcji społecznych. Są one przeznaczone dla większych grup');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('327','Physical skills','To gry, które obejmują wyzwania związane z umiejętnościami motorycznymi');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('329','Puzzle','Gry planszowe oparte na rozwiązywaniu zagadki, są zwykle grami dla jednego gracza');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('331','Race','Gry, w których każdy gracz ma cel, aby zakończyć zadanie jako pierwszy');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('333','Word','Gry wykorzystujące testowanie słownictwa graczy, umiejętności twórczego myślenia, pisowni lub szybkiego wymyślania słów');
Insert into SYSTEM.GP_MECHANIKI (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('335','Wargame','Są opartymi na strategii grami planszowymi z motywem wojennym. Ich mechanika jest ściśle związana z symulacją bitew');
REM INSERTING into SYSTEM.GP_MECHANIKI_KOPIA
SET DEFINE OFF;
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('301','Auction','Aukcyjne gry planszowe to te, które używają licytacji, przypisywania wartości do różnych przedmiotów');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('303','Area control','Gry z jakąś formą mapy lub planszy definiującą przestrzeń, o którą gracze konkurują, aby dominować');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('305','Campaign','Gry są definiowane przez graczy po serii powiązanych scenariuszy, w których wynik jednego scenariusza będzie miały wpływ na następny');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('307','City building','Gry obejmują budowanie i zarządzanie miastem poprzez decyzje dotyczące planowania');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('309','Cooperative','To gry, w których wszyscy gracze pracują razem, aby osiągnąć wspólny cel, a nie konkurować ze sobą');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('311','Cross and circle','To gry wyścigowe z planszami składającymi się z koła podzielonego na cztery równe części przez krzyż wpisany w niego');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('313','Economic','Gry planszowe obejmujące zarządzanie zasobami i podejmowanie mądrych decyzji o tym, jak wydawać lub inwestować pieniądze');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('315','Educational','To gry, które mają na celu nauczanie nowych pomysłów, koncepcji, tematów');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('317','Guessing','To gry, które angażują gracza lub graczy, odgadujących odpowiedź na pytanie w oparciu o wskazówki innego gracza');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('319','Hidden role','To gry z udziałem gracza lub graczy z ukrytą rolą w grupie, w której reszta graczy musi ją zidentyfikować');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('321','Memory','Gry pamięciowe dotyczą zapamiętywania pewnych faktów, liczb i innych informacji');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('323','Paper-and-pencil','To gry, które można odtwarzać wyłącznie za pomocą narzędzi do pisania, zwykle bez wymazywania');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('325','Party','To gry, które zachęcają do interakcji społecznych. Są one przeznaczone dla większych grup');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('327','Physical skills','To gry, które obejmują wyzwania związane z umiejętnościami motorycznymi');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('329','Puzzle','Gry planszowe oparte na rozwiązywaniu zagadki, są zwykle grami dla jednego gracza');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('331','Race','Gry, w których każdy gracz ma cel, aby zakończyć zadanie jako pierwszy');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('333','Word','Gry wykorzystujące testowanie słownictwa graczy, umiejętności twórczego myślenia, pisowni lub szybkiego wymyślania słów');
Insert into SYSTEM.GP_MECHANIKI_KOPIA (ID_MECHANIKI,NAZWA_MECHANIKI,OPIS_MECHANIKI) values ('335','Wargame','Są opartymi na strategii grami planszowymi z motywem wojennym. Ich mechanika jest ściśle związana z symulacją bitew');
REM INSERTING into SYSTEM.GP_MOTYWY
SET DEFINE OFF;
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('10','Adventure');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('15','Civil War');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('20','Fantasy');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('25','Farming');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('30','Industry');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('35','Historical simulation');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('40','Mafia');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('45','Murder mystery');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('50','Mythology');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('55','Nautical');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('60','Political');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('65','Science fiction');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('70','Sports');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('75','Train');
Insert into SYSTEM.GP_MOTYWY (ID_MOTYWU,NAZWA_MOTYWU) values ('80','Travel');
REM INSERTING into SYSTEM.GP_OCENY
SET DEFINE OFF;
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('11','0');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('12','0,5');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('13','1');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('14','1,5');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('15','2');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('16','2,5');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('17','3');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('18','3,5');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('19','4');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('20','4,5');
Insert into SYSTEM.GP_OCENY (ID_OCENY,OCENA) values ('21','5');
REM INSERTING into SYSTEM.GP_PRODUCENCI
SET DEFINE OFF;
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1010','Asmodee','101');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1020','Hasbro Gaming','102');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1030','Mattel','102');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1040','Fantasy Flight Games','102');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1050','Czech Games Edition','103');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1060','Days of Wonder','102');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1070','Z-Man Games','104');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1080','Rio Grande Games','102');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1090','Repos Production','101');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1100','Stonemaier Games','102');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1110','Portal Games','105');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1120','Egmont Polska','105');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1130','Yunnan Hongsheng','106');
Insert into SYSTEM.GP_PRODUCENCI (ID_PRODUCENTA,NAZWA_PRODUCENTA,ID_LOKALIZACJI) values ('1140','Trefl','105');
REM INSERTING into SYSTEM.GP_RECENZENCI
SET DEFINE OFF;
Insert into SYSTEM.GP_RECENZENCI (ID_RECENZENTA,IMIE,NAZWISKO) values ('201','Wanda','Raczyńska');
Insert into SYSTEM.GP_RECENZENCI (ID_RECENZENTA,IMIE,NAZWISKO) values ('202','Tymon','Słupek');
Insert into SYSTEM.GP_RECENZENCI (ID_RECENZENTA,IMIE,NAZWISKO) values ('203','Iwona','Cebulak');
Insert into SYSTEM.GP_RECENZENCI (ID_RECENZENTA,IMIE,NAZWISKO) values ('204','Mieczysław','Siarkiewicz');
Insert into SYSTEM.GP_RECENZENCI (ID_RECENZENTA,IMIE,NAZWISKO) values ('205','Pola','Machniak');
Insert into SYSTEM.GP_RECENZENCI (ID_RECENZENTA,IMIE,NAZWISKO) values ('206','Aleksander','Osadnik');
Insert into SYSTEM.GP_RECENZENCI (ID_RECENZENTA,IMIE,NAZWISKO) values ('207','Maja','Serkowska');
REM INSERTING into SYSTEM.GP_RECENZJE
SET DEFINE OFF;
Insert into SYSTEM.GP_RECENZJE (ID_RECENZJI,ID_GRY,ID_RECENZENTA,ID_OCENY) values ('9100','5009','203','20');
Insert into SYSTEM.GP_RECENZJE (ID_RECENZJI,ID_GRY,ID_RECENZENTA,ID_OCENY) values ('9200','5004','206','18');
Insert into SYSTEM.GP_RECENZJE (ID_RECENZJI,ID_GRY,ID_RECENZENTA,ID_OCENY) values ('9300','5002','201','20');
Insert into SYSTEM.GP_RECENZJE (ID_RECENZJI,ID_GRY,ID_RECENZENTA,ID_OCENY) values ('9400','5014','205','21');
Insert into SYSTEM.GP_RECENZJE (ID_RECENZJI,ID_GRY,ID_RECENZENTA,ID_OCENY) values ('9401','5014','202','17');
REM INSERTING into SYSTEM.HALE
SET DEFINE OFF;
Insert into SYSTEM.HALE (ID_HALI,NAZWA) values ('1','Hala produkcyjna 1');
Insert into SYSTEM.HALE (ID_HALI,NAZWA) values ('2','Magazyn A');
Insert into SYSTEM.HALE (ID_HALI,NAZWA) values ('3','Budynek administracyjny');
...
SET DEFINE OFF;
Insert into SYSTEM.MASZYNY (ID_MASZYNY,NAZWA,DATA_URUCHOMIENIA,ID_HALI) values ('10','Obrabiarka numeryczna',to_date('01/10/23','RR/MM/DD'),'1');
Insert into SYSTEM.MASZYNY (ID_MASZYNY,NAZWA,DATA_URUCHOMIENIA,ID_HALI) values ('20','Wózek widłowy "Lemur"',to_date('11/03/27','RR/MM/DD'),'2');
Insert into SYSTEM.MASZYNY (ID_MASZYNY,NAZWA,DATA_URUCHOMIENIA,ID_HALI) values ('30','Suwnica',to_date('01/03/11','RR/MM/DD'),'1');
Insert into SYSTEM.MASZYNY (ID_MASZYNY,NAZWA,DATA_URUCHOMIENIA,ID_HALI) values ('40','Ploter tnący A-32',to_date('14/02/10','RR/MM/DD'),'3');
Insert into SYSTEM.MASZYNY (ID_MASZYNY,NAZWA,DATA_URUCHOMIENIA,ID_HALI) values ('50','Tokarka',to_date('06/07/05','RR/MM/DD'),'1');
Insert into SYSTEM.MASZYNY (ID_MASZYNY,NAZWA,DATA_URUCHOMIENIA,ID_HALI) values ('60','Prasa hydrauliczna',to_date('03/11/09','RR/MM/DD'),'1');
Insert into SYSTEM.MASZYNY (ID_MASZYNY,NAZWA,DATA_URUCHOMIENIA,ID_HALI) values ('70','Wózek widłowy "Lemur lux"',to_date('14/03/13','RR/MM/DD'),'2');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.OPERATOR_MASZYNA
SET DEFINE OFF;
Insert into SYSTEM.OPERATOR_MASZYNA (ID_OPERATORA,ID_MASZYNY) values ('10','30');
Insert into SYSTEM.OPERATOR_MASZYNA (ID_OPERATORA,ID_MASZYNY) values ('10','60');
Insert into SYSTEM.OPERATOR_MASZYNA (ID_OPERATORA,ID_MASZYNY) values ('20','10');
Insert into SYSTEM.OPERATOR_MASZYNA (ID_OPERATORA,ID_MASZYNY) values ('30','20');
Insert into SYSTEM.OPERATOR_MASZYNA (ID_OPERATORA,ID_MASZYNY) values ('30','70');
Insert into SYSTEM.OPERATOR_MASZYNA (ID_OPERATORA,ID_MASZYNY) values ('40','50');
Insert into SYSTEM.OPERATOR_MASZYNA (ID_OPERATORA,ID_MASZYNY) values ('60','40');
REM INSERTING into SYSTEM.OPERATORZY
SET DEFINE OFF;
Insert into SYSTEM.OPERATORZY (ID_OPERATORA,NAZWISKO,IMIE,DATA_ZATRUDNIENIA,PLACA,"PRZEŁOŻONY") values ('10','SCHWARZENEGGER','ARNOLD',to_date('03/03/30','RR/MM/DD'),'1050',null);
Insert into SYSTEM.OPERATORZY (ID_OPERATORA,NAZWISKO,IMIE,DATA_ZATRUDNIENIA,PLACA,"PRZEŁOŻONY") values ('20','MACGYVER','ANGUS',to_date('06/11/12','RR/MM/DD'),'900','10');
Insert into SYSTEM.OPERATORZY (ID_OPERATORA,NAZWISKO,IMIE,DATA_ZATRUDNIENIA,PLACA,"PRZEŁOŻONY") values ('30','BOND','JAMES',to_date('02/03/13','RR/MM/DD'),'1100',null);
Insert into SYSTEM.OPERATORZY (ID_OPERATORA,NAZWISKO,IMIE,DATA_ZATRUDNIENIA,PLACA,"PRZEŁOŻONY") values ('40','NORRIS','CHUCK',to_date('09/10/21','RR/MM/DD'),'870','10');
Insert into SYSTEM.OPERATORZY (ID_OPERATORA,NAZWISKO,IMIE,DATA_ZATRUDNIENIA,PLACA,"PRZEŁOŻONY") values ('50','STALLONE','SYLVESTER',to_date('10/01/01','RR/MM/DD'),'999','30');
Insert into SYSTEM.OPERATORZY (ID_OPERATORA,NAZWISKO,IMIE,DATA_ZATRUDNIENIA,PLACA,"PRZEŁOŻONY") values ('60','WILLIS','BRUCE',to_date('08/05/21','RR/MM/DD'),'800','10');
REM INSERTING into SYSTEM.PRACOWNIK
SET DEFINE OFF;
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1000','Lech','DYREKTOR',null,to_date('71/01/01','RR/MM/DD'),'3160','570','10');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1080','Koliberek','SEKRETARKA','1000',to_date('83/02/20','RR/MM/DD'),'1150',null,'10');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1010','Podgajny','PROFESOR','1000',to_date('75/05/01','RR/MM/DD'),'2180','420','20');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1040','Rus','ADIUNKT','1010',to_date('79/09/15','RR/MM/DD'),'1750',null,'20');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1070','Muszy�ski','ADIUNKT','1010',to_date('85/05/01','RR/MM/DD'),'1600',null,'20');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1060','Misiecki','ASYSTENT','1010',to_date('85/03/01','RR/MM/DD'),'1400',null,'20');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1090','Palusz','ASYSTENT','1040',to_date('89/09/15','RR/MM/DD'),'1200',null,'20');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1020','Delcki','PROFESOR','1000',to_date('77/09/01','RR/MM/DD'),'2050','270','30');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1030','Maleja','ADIUNKT','1020',to_date('68/07/01','RR/MM/DD'),'1750',null,'30');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1100','Warski','ASYSTENT','1030',to_date('87/07/14','RR/MM/DD'),'1350',null,'30');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1110','Rajski','STA�YSTA','1030',to_date('90/07/01','RR/MM/DD'),'900',null,'30');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1050','Lubicz','ADIUNKT','1000',to_date('83/09/01','RR/MM/DD'),'1780',null,'40');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1120','Orka','ASYSTENT','1050',to_date('88/04/01','RR/MM/DD'),'1350',null,'40');
Insert into SYSTEM.PRACOWNIK (NUMER,NAZWISKO,ETAT,SZEF,PRACUJE_OD,PLACA_POD,PLACA_DOD,ID_ZESP) values ('1130','Kolski','STA�YSTA','1050',to_date('91/09/01','RR/MM/DD'),'900',null,'40');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ZESPOL
SET DEFINE OFF;
Insert into SYSTEM.ZESPOL (ID_ZESP,NAZWA,ADRES) values ('10','ADMINISTRACJA','PIOTROWO 3A');
Insert into SYSTEM.ZESPOL (ID_ZESP,NAZWA,ADRES) values ('20','BAZY DANYCH','WIE�OWA 75');
Insert into SYSTEM.ZESPOL (ID_ZESP,NAZWA,ADRES) values ('30','SIECI KOMPUTEROWE','GARBARY 3');
Insert into SYSTEM.ZESPOL (ID_ZESP,NAZWA,ADRES) values ('40','SYSTEMY OPERACYJNE','PIOTROWO 3A');
Insert into SYSTEM.ZESPOL (ID_ZESP,NAZWA,ADRES) values ('50','TRANSLATORY','MANSFELDA 4');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."KEY_1" ON "SYSTEM"."AWARIE" ("CZAS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_ID_ZESP
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_ID_ZESP" ON "SYSTEM"."ZESPOL" ("ID_ZESP") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index PK_LICZ_GRACZY
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_LICZ_GRACZY" ON "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" ("ID_LICZBY_GRACZY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index RELATION_3__IDX
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."RELATION_3__IDX" ON "SYSTEM"."OPERATOR_MASZYNA" ("ID_OPERATORA", "ID_MASZYNY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index Hala PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."Hala PK" ON "SYSTEM"."HALE" ("ID_HALI") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_KAT_WIEK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_KAT_WIEK" ON "SYSTEM"."GP_KATEGORIE_WIEKOWE" ("ID_KATEGORII_WIEKOWEJ") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index PK_E_ROZGR
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_E_ROZGR" ON "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" ("ID_ELEMENTU_ROZGRYWKI") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_RECENZENCI
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_RECENZENCI" ON "SYSTEM"."GP_RECENZENCI" ("ID_RECENZENTA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_PRODUCENCI" ON "SYSTEM"."GP_PRODUCENCI" ("ID_PRODUCENTA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_OCENY
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_OCENY" ON "SYSTEM"."GP_OCENY" ("ID_OCENY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index PK_LOKALIZACJE
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_LOKALIZACJE" ON "SYSTEM"."GP_LOKALIZACJE" ("ID_LOKALIZACJI") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index Maszyna PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."Maszyna PK" ON "SYSTEM"."MASZYNY" ("ID_MASZYNY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index PK_NAZWA
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_NAZWA" ON "SYSTEM"."ETAT" ("NAZWA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index PK_GRY
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_GRY" ON "SYSTEM"."GP_GRY_PLANSZOWE" ("ID_GRY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index PK_KOMPONENTY
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_KOMPONENTY" ON "SYSTEM"."GP_KOMPONENTY" ("ID_KOMPONENTU") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index PK_MOTYWY
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_MOTYWY" ON "SYSTEM"."GP_MOTYWY" ("ID_MOTYWU") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_RECENZJE
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_RECENZJE" ON "SYSTEM"."GP_RECENZJE" ("ID_RECENZJI") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index Operator PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."Operator PK" ON "SYSTEM"."OPERATORZY" ("ID_OPERATORA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_MECHANIKI
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_MECHANIKI" ON "SYSTEM"."GP_MECHANIKI" ("ID_MECHANIKI") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index PK_E_ZEST
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_E_ZEST" ON "SYSTEM"."GP_ELEMENTY_ZESTAWU" ("ID_ELEMENTU_ZESTAWU") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_NUMER
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_NUMER" ON "SYSTEM"."PRACOWNIK" ("NUMER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Procedure NOWA_LOKALIZACJA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."NOWA_LOKALIZACJA" (id NUMBER, n_kraj VARCHAR2)
AS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Function ID_KRAJU
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."ID_KRAJU" (kraj_n VARCHAR2) 
RETURN NUMBER
IS
    wynik number;
BEGIN
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table OPERATORZY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."OPERATORZY" MODIFY ("IMIE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."OPERATORZY" MODIFY ("NAZWISKO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."OPERATORZY" MODIFY ("ID_OPERATORA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."OPERATORZY" ADD CONSTRAINT "Operator PK" PRIMARY KEY ("ID_OPERATORA")
  USING INDEX "SYSTEM"."Operator PK"  ENABLE;
--------------------------------------------------------
--  Constraints for Table GP_KATEGORIE_WIEKOWE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_KATEGORIE_WIEKOWE" MODIFY ("ID_KATEGORII_WIEKOWEJ" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_KATEGORIE_WIEKOWE" ADD CONSTRAINT "PK_KAT_WIEK" PRIMARY KEY ("ID_KATEGORII_WIEKOWEJ")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_KATEGORIE_WIEKOWE" MODIFY ("NAZWA_K_WIEKOWEJ" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_KATEGORIE_WIEKOWE" MODIFY ("MINIMALNY_WIEK" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table GP_KATEGORIE_LICZBY_GRACZY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" MODIFY ("ID_LICZBY_GRACZY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" ADD CONSTRAINT "PK_LICZ_GRACZY" PRIMARY KEY ("ID_LICZBY_GRACZY")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" MODIFY ("NAZWA_K_L_GRACZY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" MODIFY ("MIN_LICZBA_GRACZY" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Constraints for Table AWARIE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."AWARIE" ADD CONSTRAINT "KEY_1" PRIMARY KEY ("CZAS")
  USING INDEX "SYSTEM"."KEY_1"  ENABLE;
  ALTER TABLE "SYSTEM"."AWARIE" MODIFY ("ID_MASZYNY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AWARIE" MODIFY ("OPIS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AWARIE" MODIFY ("CZAS" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ETAT" MODIFY ("PLACA_MIN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ETAT" MODIFY ("PLACA_MAX" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ETAT" ADD CONSTRAINT "PL_MIN" CHECK (placa_min>0) ENABLE;
  ALTER TABLE "SYSTEM"."ETAT" ADD CONSTRAINT "PL_MAX" CHECK (placa_max<5000) ENABLE;
  ALTER TABLE "SYSTEM"."ETAT" ADD CONSTRAINT "PK_NAZWA" PRIMARY KEY ("NAZWA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table GP_ELEMENTY_ROZGRYWKI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" MODIFY ("ID_ELEMENTU_ROZGRYWKI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" ADD CONSTRAINT "PK_E_ROZGR" PRIMARY KEY ("ID_ELEMENTU_ROZGRYWKI")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" MODIFY ("ID_MECHANIKI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" MODIFY ("ID_GRY" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table GP_RECENZJE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_RECENZJE" MODIFY ("ID_RECENZJI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_RECENZJE" MODIFY ("RECENZJA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_RECENZJE" MODIFY ("ID_GRY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_RECENZJE" MODIFY ("ID_RECENZENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_RECENZJE" MODIFY ("ID_OCENY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_RECENZJE" ADD CONSTRAINT "PK_RECENZJE" PRIMARY KEY ("ID_RECENZJI")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table GP_GRY_PLANSZOWE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" MODIFY ("ID_GRY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" ADD CONSTRAINT "PK_GRY" PRIMARY KEY ("ID_GRY")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" MODIFY ("NAZWA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" MODIFY ("DATA_WYDANIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" MODIFY ("ID_KATEGORII_WIEKOWEJ" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" MODIFY ("ID_LICZBY_GRACZY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" MODIFY ("ID_PRODUCENTA" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table GP_ELEMENTY_ZESTAWU
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" MODIFY ("ID_ELEMENTU_ZESTAWU" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" ADD CONSTRAINT "PK_E_ZEST" PRIMARY KEY ("ID_ELEMENTU_ZESTAWU")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" MODIFY ("LICZBA_KOMPONENTOW" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" MODIFY ("ID_KOMPONENTU" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" MODIFY ("ID_GRY" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GP_MECHANIKI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_MECHANIKI" MODIFY ("ID_MECHANIKI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_MECHANIKI" ADD CONSTRAINT "PK_MECHANIKI" PRIMARY KEY ("ID_MECHANIKI")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_MECHANIKI" MODIFY ("NAZWA_MECHANIKI" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table GP_OCENY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_OCENY" MODIFY ("ID_OCENY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_OCENY" ADD CONSTRAINT "PK_OCENY" PRIMARY KEY ("ID_OCENY")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_OCENY" MODIFY ("OCENA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GP_LOKALIZACJE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_LOKALIZACJE" MODIFY ("ID_LOKALIZACJI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_LOKALIZACJE" ADD CONSTRAINT "PK_LOKALIZACJE" PRIMARY KEY ("ID_LOKALIZACJI")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_LOKALIZACJE" MODIFY ("KRAJ" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table GP_MECHANIKI_KOPIA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_MECHANIKI_KOPIA" MODIFY ("ID_MECHANIKI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_MECHANIKI_KOPIA" MODIFY ("NAZWA_MECHANIKI" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table OPERATOR_MASZYNA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."OPERATOR_MASZYNA" ADD CONSTRAINT "RELATION_3__IDX" PRIMARY KEY ("ID_OPERATORA", "ID_MASZYNY")
  USING INDEX "SYSTEM"."RELATION_3__IDX"  ENABLE;
  ALTER TABLE "SYSTEM"."OPERATOR_MASZYNA" MODIFY ("ID_MASZYNY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."OPERATOR_MASZYNA" MODIFY ("ID_OPERATORA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ZESPOL" MODIFY ("NAZWA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ZESPOL" ADD CONSTRAINT "PK_ID_ZESP" PRIMARY KEY ("ID_ZESP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table GP_RECENZENCI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_RECENZENCI" MODIFY ("ID_RECENZENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_RECENZENCI" ADD CONSTRAINT "PK_RECENZENCI" PRIMARY KEY ("ID_RECENZENTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_RECENZENCI" MODIFY ("IMIE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_RECENZENCI" MODIFY ("NAZWISKO" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MASZYNY" ADD CONSTRAINT "Maszyna PK" PRIMARY KEY ("ID_MASZYNY")
  USING INDEX "SYSTEM"."Maszyna PK"  ENABLE;
  ALTER TABLE "SYSTEM"."MASZYNY" MODIFY ("ID_HALI" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MASZYNY" MODIFY ("NAZWA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MASZYNY" MODIFY ("ID_MASZYNY" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" )  ENABLE;
--------------------------------------------------------
--  Constraints for Table HALE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HALE" ADD CONSTRAINT "Hala PK" PRIMARY KEY ("ID_HALI")
  USING INDEX "SYSTEM"."Hala PK"  ENABLE;
  ALTER TABLE "SYSTEM"."HALE" MODIFY ("NAZWA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HALE" MODIFY ("ID_HALI" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GP_PRODUCENCI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_PRODUCENCI" MODIFY ("ID_PRODUCENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_PRODUCENCI" ADD CONSTRAINT "PK_PRODUCENCI" PRIMARY KEY ("ID_PRODUCENTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_PRODUCENCI" MODIFY ("NAZWA_PRODUCENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_PRODUCENCI" MODIFY ("ID_LOKALIZACJI" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PRACOWNIK
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRACOWNIK" MODIFY ("NAZWISKO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRACOWNIK" MODIFY ("PLACA_POD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRACOWNIK" ADD CONSTRAINT "PL_POD" CHECK (placa_pod>0) ENABLE;
  ALTER TABLE "SYSTEM"."PRACOWNIK" ADD CONSTRAINT "PK_NUMER" PRIMARY KEY ("NUMER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table GP_KOMPONENTY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_KOMPONENTY" MODIFY ("ID_KOMPONENTU" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_KOMPONENTY" ADD CONSTRAINT "PK_KOMPONENTY" PRIMARY KEY ("ID_KOMPONENTU")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_KOMPONENTY" MODIFY ("NAZWA_KOMPONENTU" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GP_MOTYWY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_MOTYWY" MODIFY ("ID_MOTYWU" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GP_MOTYWY" ADD CONSTRAINT "PK_MOTYWY" PRIMARY KEY ("ID_MOTYWU")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GP_MOTYWY" MODIFY ("NAZWA_MOTYWU" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AWARIE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."AWARIE" ADD CONSTRAINT "MASZYNA_AWARIA" FOREIGN KEY ("ID_MASZYNY")
	  REFERENCES "SYSTEM"."MASZYNY" ("ID_MASZYNY") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GP_ELEMENTY_ROZGRYWKI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" ADD CONSTRAINT "FK_E_ROZG_MECH" FOREIGN KEY ("ID_MECHANIKI")
	  REFERENCES "SYSTEM"."GP_MECHANIKI" ("ID_MECHANIKI") ENABLE;
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ROZGRYWKI" ADD CONSTRAINT "FK_E_ROZG_GRA" FOREIGN KEY ("ID_GRY")
	  REFERENCES "SYSTEM"."GP_GRY_PLANSZOWE" ("ID_GRY") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GP_ELEMENTY_ZESTAWU
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" ADD CONSTRAINT "FK_E_ZEST_KOMP" FOREIGN KEY ("ID_KOMPONENTU")
	  REFERENCES "SYSTEM"."GP_KOMPONENTY" ("ID_KOMPONENTU") ENABLE;
  ALTER TABLE "SYSTEM"."GP_ELEMENTY_ZESTAWU" ADD CONSTRAINT "FK_E_ZEST_GRA" FOREIGN KEY ("ID_GRY")
	  REFERENCES "SYSTEM"."GP_GRY_PLANSZOWE" ("ID_GRY") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GP_GRY_PLANSZOWE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" ADD CONSTRAINT "FK_GRY_WIEK" FOREIGN KEY ("ID_KATEGORII_WIEKOWEJ")
	  REFERENCES "SYSTEM"."GP_KATEGORIE_WIEKOWE" ("ID_KATEGORII_WIEKOWEJ") ENABLE;
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" ADD CONSTRAINT "FK_GRY_MOT" FOREIGN KEY ("ID_MOTYWU")
	  REFERENCES "SYSTEM"."GP_MOTYWY" ("ID_MOTYWU") ENABLE;
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" ADD CONSTRAINT "FK_GRY_GRACZE" FOREIGN KEY ("ID_LICZBY_GRACZY")
	  REFERENCES "SYSTEM"."GP_KATEGORIE_LICZBY_GRACZY" ("ID_LICZBY_GRACZY") ENABLE;
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" ADD CONSTRAINT "FK_GRY_PROD" FOREIGN KEY ("ID_PRODUCENTA")
	  REFERENCES "SYSTEM"."GP_PRODUCENCI" ("ID_PRODUCENTA") ENABLE;
  ALTER TABLE "SYSTEM"."GP_GRY_PLANSZOWE" ADD CONSTRAINT "FK_GRY_WER" FOREIGN KEY ("ID_PIERWOTNEJ_WERSJI")
	  REFERENCES "SYSTEM"."GP_GRY_PLANSZOWE" ("ID_GRY") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GP_PRODUCENCI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_PRODUCENCI" ADD CONSTRAINT "FK_PRODUCENCI_LOK" FOREIGN KEY ("ID_LOKALIZACJI")
	  REFERENCES "SYSTEM"."GP_LOKALIZACJE" ("ID_LOKALIZACJI") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GP_RECENZJE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GP_RECENZJE" ADD CONSTRAINT "FK_RECENZJE_GRA" FOREIGN KEY ("ID_GRY")
	  REFERENCES "SYSTEM"."GP_GRY_PLANSZOWE" ("ID_GRY") ENABLE;
  ALTER TABLE "SYSTEM"."GP_RECENZJE" ADD CONSTRAINT "FK_RECENZJE_REC" FOREIGN KEY ("ID_RECENZENTA")
	  REFERENCES "SYSTEM"."GP_RECENZENCI" ("ID_RECENZENTA") ENABLE;
  ALTER TABLE "SYSTEM"."GP_RECENZJE" ADD CONSTRAINT "FK_RECENZJE_OC" FOREIGN KEY ("ID_OCENY")
	  REFERENCES "SYSTEM"."GP_OCENY" ("ID_OCENY") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MASZYNY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MASZYNY" ADD CONSTRAINT "HALA_MASZYNA" FOREIGN KEY ("ID_HALI")
	  REFERENCES "SYSTEM"."HALE" ("ID_HALI") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_ROLLUP" ADD CONSTRAINT "MVIEW$_ADV_ROLLUP_PFK" FOREIGN KEY ("RUNID#", "PLEVELID#")
	  REFERENCES "SYSTEM"."MVIEW$_ADV_LEVEL" ("RUNID#", "LEVELID#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table OPERATOR_MASZYNA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."OPERATOR_MASZYNA" ADD CONSTRAINT "FK_ASS_3" FOREIGN KEY ("ID_OPERATORA")
	  REFERENCES "SYSTEM"."OPERATORZY" ("ID_OPERATORA") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."OPERATOR_MASZYNA" ADD CONSTRAINT "FK_ASS_4" FOREIGN KEY ("ID_MASZYNY")
	  REFERENCES "SYSTEM"."MASZYNY" ("ID_MASZYNY") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table OPERATORZY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."OPERATORZY" ADD CONSTRAINT "SZEF_PODWŁADNY" FOREIGN KEY ("PRZEŁOŻONY")
	  REFERENCES "SYSTEM"."OPERATORZY" ("ID_OPERATORA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRACOWNIK
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRACOWNIK" ADD CONSTRAINT "FK_ETAT" FOREIGN KEY ("ETAT")
	  REFERENCES "SYSTEM"."ETAT" ("NAZWA") ENABLE;
  ALTER TABLE "SYSTEM"."PRACOWNIK" ADD CONSTRAINT "FK_SZEF" FOREIGN KEY ("SZEF")
	  REFERENCES "SYSTEM"."PRACOWNIK" ("NUMER") ENABLE;
  ALTER TABLE "SYSTEM"."PRACOWNIK" ADD CONSTRAINT "FK_IDZESP" FOREIGN KEY ("ID_ZESP")
	  REFERENCES "SYSTEM"."ZESPOL" ("ID_ZESP") ENABLE;
